...
def animate(frame):
    ...
    frame_number = ax.text(8.5,25,'test')
    ...
    frame_number.set_text(str(tick))
  
    return [ax.scatter(bacteria_x_coords, bacteria_y_coords, color = 'b'), ax.scatter(phage_x_coords, phage_y_coords, color = 'g'), ax.scatter(antibiotic_x_coords, antibiotic_y_coords, color = 'r'), average_resistance, frame_number]
